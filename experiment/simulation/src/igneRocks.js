...
var htm='<div class="row">'
			...
			+'</div>'
			+'<div class="col-sm-2">'
			+'<strong><center><span>Select igneous rocks</span></center></strong>'
			+'</div>'
			+'<div class="col-sm-7">'
			+'<select class="custom-select" id="mineral"  >'
			+'<option>------ Select igneous rocks ------</option>'
	for(i=0;i<SampleRandomArr.length;i++){
			htm+='<option  value="'+ SampleRandomArr[i]+'">Igneous Rock '+ SampleRandomArr[i] +'</option>'
		}
		htm+='</select>'			
			+'</div>'
			+'</div>'
...
var thoery='<div class="container col-sm-12"  id="theory">'
	...
	+'</p>'
	+'<p><b>Different Types of igneous rocks</b><br>'
	+'<ul><li><b>Intrusive igneous rock:</b> These rocks crystallize below the earth\'s surface resulting in large crystals as the cooling takes place slowly. Diorite, granite, pegmatite are examples of intrusive igneous rocks.<br>'
	+' <li><b>Extrusive igneous rock:</b> These rocks erupt onto the surface resulting in small crystals as the cooling takes place quickly. The cooling rate is for a few rocks is so quick that they form an amorphous glass. Basalt, tuff, pumice are examples of extrusive igneous rock.'
	+'</ul>'
	+'</p>'
	+'<p><b>Identification based on the various physical properties of igneous rocks are as follows </b><br>'
	+'<ul>'
	+'<li>Form '
	+'<li>Colour '
	+'<li>Fracture '
		...
		for(i=0,j=1;i<tempMasterJson.demo.length;i++,j++){	
			 if(mineral==tempMasterJson.demo[i].mineralId){	
				 ...
				 var text='<div class="col-lg-2  col-sm-12">'
					 	...
					 	text+='</div>'
						+'<br>'
					 	+'<strong><b id="SelectOriginalName">what is the name of above igneous rock ?</b></strong>'
					 	+'<br>'
					 	+'<br>'
					 	+'<select class="custom-select" id="originalName"  >'
					 	+'<option  value="">------ Select original name of igneous rocks ------</option>'
